...
const Banner = ({ title, breadCrumbs }) => {
  return (
    <Section
      className={`pt-[2.5rem]  h-[400px] relative after:absolute after:top-0 after:left-0 after:h-full after:w-full after:z-10  after:bg-no-repeat after:opacity-[0.4]  bg-center  banner mt-0 after:bg-black bg-cover lg:bg-cover   `}>
